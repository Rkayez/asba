...
methods = """                      
            ...
            \033[1;35m║ \033[1;32mlayer4 > Shows layer4 Methods!\033[1;35m   ║
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;Joker. | Devices: [{}] | Spoofed Servers [TEST] | Server Units [TEST] | Clients: [TEST]\x07".format (bots))
